...
module.exports = {
  ...
  campaign: {
    enabled: true,
    badge: '3 AL 2 ÖDE',
    line: 'Pandora Club üyelerine özel',
  ...
  bracelets: [
    { key: 'silver', label: 'Gümüş', metal: '925 ayar gümüş', sku: '599652C01', title: 'Pandora Moments Yılan Zincir Bileklik', price: 5269,
      url: 'https://tr.pandora.net/tr/bileklikler/zincir-bileklikler/pandora-moments-yilan-zincir-bileklik/599652C01.html',
      alt: ['https://www.pandora.net/tr-tr/products/bracelets/silver/599652c01-2'],
      swatch: ['#ffffff', '#d9dde3', '#8f97a3'], tone: '#c9ced6' },
    { key: 'rose', label: 'Rose', metal: '14 ayar pembe altın kaplama', sku: '580728', title: 'Moments 14 Ayar Pembe Altın Kaplama Bileklik', price: null,
      url: 'https://tr.pandora.net/tr/bileklikler/zincir-bileklikler/moments-14-ayar-pembe-altin-kaplama-bileklik/580728.html',
      alt: [], swatch: ['#ffe9e2', '#e9b4a4', '#b9766a'], tone: '#e3b3a4' },
    { key: 'gold', label: 'Altın', metal: '14 ayar altın kaplama', sku: '568748C00', title: 'Moments 14 Ayar Altın Kaplama Düz Klipsli Bileklik', price: null,
  ...
  charms: [
    ...
    { key: 'murano', short: 'Pembe Murano', sku: '789421C00', title: 'Mat Pembe Murano Cam Charm', price: 2209,
      url: 'https://tr.pandora.net/tr/charmlar-ve-bileklikler/charmlar/charmlar/mat-pembe-murano-cam-charm/789421C00.html' },
    { key: 'butterfly', short: 'Mavi Kelebek', sku: '790761C01', title: 'Mavi Kelebek Işıltılı Charm', price: 3239,
      url: 'https://tr.pandora.net/tr/charmlar-ve-bileklikler/charmlar/charmlar/mavi-kelebek-isiltili-charm/790761C01.html' },
    { key: 'star', short: 'Galaksi Yıldız', sku: '792368C01', title: 'Galaksi Yıldız Murano Sallantılı Charm', price: 2549,
    ...
    { key: 'clip', short: 'Pavé Klips', sku: '791817NSBMX', title: 'Mavi Pavé Klips Charm', price: null,
