...
- **Mutfak sahnesi sıcak noktaları** – Paket ve makine üzerinde nabız atan iki nokta; üzerine gelince (dokunmatikte dokununca) bilgi balonu.
...
- Kahraman pakete / "YENİ" rozetine tıklayınca gerçek çekirdek sprite'ları saçılır. **Siteye yalnızca "Ürünü Keşfet" düğmesi yönlendirir** (seçili ürünün sayfasına, UTM'li; `clickTag` / `Enabler.exit` desteği) – paketler, sıcak noktalar ve boş alan tıklaması sayfa açmaz. 3,5 sn'de kısa "PAKETLERE DOKUN · SERİYİ KEŞFET" ipucu, ilk etkileşimde kaybolur.
